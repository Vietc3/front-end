        ...
        >
            <Box
                ...
                >
                    ...
                    <Center pl={{ base: '0px', lg: "80px" }}
                        pr={{ base: '0px', lg: "80px" }} as="section">
                        <Box w={{ base: "100%", md: "100%", lg: "50%" }} textAlign="center" color="red" as="article" margin=".5rem">
                    ...
                    <Center pl={{ base: '0px', lg: "80px" }}
                        pr={{ base: '0px', lg: "80px" }} as="section">
                        <Box w={{ base: "100%", md: "100%", lg: "65%" }} textAlign="center" color="black" as="article" margin=".5rem">
                            <Text fontSize={{ base: "md", md: "xl" }}
                                pt={5}>
                                You have been added to our list and we're delighted to be sharing more and great content with you
                            </Text>
                        </Box>
                    </Center>
